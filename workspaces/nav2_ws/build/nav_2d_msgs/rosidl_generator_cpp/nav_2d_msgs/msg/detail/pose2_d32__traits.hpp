...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav_2d_msgs::msg::Pose2D32>, int> = 0>
...
template<>
constexpr const char * data_type<nav_2d_msgs::msg::Pose2D32>()
{
  return "nav_2d_msgs::msg::Pose2D32";
}

template<>
constexpr const char * name<nav_2d_msgs::msg::Pose2D32>()
{
  return "nav_2d_msgs/msg/Pose2D32";
}
...
template<>
struct MessageTraits<nav_2d_msgs::msg::Pose2D32>
{
