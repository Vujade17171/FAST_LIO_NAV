...
bool nav_2d_msgs__msg__twist2_d_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav_2d_msgs.msg._twist2_d_stamped", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("Twist2DStamped", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
