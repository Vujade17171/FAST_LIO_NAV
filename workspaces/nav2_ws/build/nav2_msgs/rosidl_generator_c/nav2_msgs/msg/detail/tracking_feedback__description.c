...
static char nav2_msgs__msg__TrackingFeedback__FIELD_NAME__position_tracking_error[] = "position_tracking_error";
static char nav2_msgs__msg__TrackingFeedback__FIELD_NAME__heading_tracking_error[] = "heading_tracking_error";
...
static rosidl_runtime_c__type_description__Field nav2_msgs__msg__TrackingFeedback__FIELDS[] = {
  ...
  {
    {nav2_msgs__msg__TrackingFeedback__FIELD_NAME__position_tracking_error, 23, 23},
    {
  ...
  {
    {nav2_msgs__msg__TrackingFeedback__FIELD_NAME__heading_tracking_error, 22, 22},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {nav2_msgs__msg__TrackingFeedback__FIELDS, 8, 8},
    },
