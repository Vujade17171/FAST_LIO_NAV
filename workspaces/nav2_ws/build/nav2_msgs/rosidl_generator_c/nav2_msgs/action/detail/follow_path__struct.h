...
typedef struct nav2_msgs__action__FollowPath_Goal
{
  ...
  rosidl_runtime_c__String path_handler_id;
...
enum
{
  nav2_msgs__action__FollowPath_Result__GOAL_REJECTED = 1
};

/// Constant 'SEND_GOAL_FAILURE'.
enum
{
  nav2_msgs__action__FollowPath_Result__SEND_GOAL_FAILURE = 2
};
...
enum
{
  nav2_msgs__action__FollowPath_Result__TIMEOUT = 108
};
