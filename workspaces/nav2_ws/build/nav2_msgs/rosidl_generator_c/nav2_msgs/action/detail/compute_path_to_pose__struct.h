...
typedef struct nav2_msgs__action__ComputePathToPose_Goal
{
  ...
  geometry_msgs__msg__PoseStamped__Sequence viapoints;
...
enum
{
  nav2_msgs__action__ComputePathToPose_Result__GOAL_REJECTED = 1
};

/// Constant 'SEND_GOAL_FAILURE'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__SEND_GOAL_FAILURE = 2
};
