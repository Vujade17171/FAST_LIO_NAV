...
nav2_msgs__srv__IsPathValid_Request__init(nav2_msgs__srv__IsPathValid_Request * msg)
{
  ...
  {
    bool success = rosidl_runtime_c__String__assign(&msg->layer_name, "");
    if (!success) {
      goto abort_init_0;
    }
  }
  ...
  {
    bool success = rosidl_runtime_c__String__assign(&msg->footprint, "");
    if (!success) {
      goto abort_init_1;
    }
  }
  // stop_at_first_collision
  msg->stop_at_first_collision = true;
  // max_lookahead_distance
  msg->max_lookahead_distance = -1.0l;
  return true;
abort_init_1:
...
nav2_msgs__srv__IsPathValid_Request__are_equal(const nav2_msgs__srv__IsPathValid_Request * lhs, const nav2_msgs__srv__IsPathValid_Request * rhs)
{
  ...
  // stop_at_first_collision
  if (lhs->stop_at_first_collision != rhs->stop_at_first_collision) {
    return false;
  }
  // max_lookahead_distance
  if (lhs->max_lookahead_distance != rhs->max_lookahead_distance) {
    return false;
  }
  return true;
}
  ...
  nav2_msgs__srv__IsPathValid_Request * output)
{
  ...
  // stop_at_first_collision
  output->stop_at_first_collision = input->stop_at_first_collision;
  // max_lookahead_distance
  output->max_lookahead_distance = input->max_lookahead_distance;
  return true;
}
...
nav2_msgs__srv__IsPathValid_Request__Sequence__init(nav2_msgs__srv__IsPathValid_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(nav2_msgs__srv__IsPathValid_Request)) {
      return false;
    }
  ...
  nav2_msgs__srv__IsPathValid_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(nav2_msgs__srv__IsPathValid_Request)) {
      return false;
    }
...
nav2_msgs__srv__IsPathValid_Response__Sequence__init(nav2_msgs__srv__IsPathValid_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(nav2_msgs__srv__IsPathValid_Response)) {
      return false;
    }
  ...
  nav2_msgs__srv__IsPathValid_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(nav2_msgs__srv__IsPathValid_Response)) {
      return false;
    }
    const size_t allocation_size =
...
nav2_msgs__srv__IsPathValid_Event__Sequence__init(nav2_msgs__srv__IsPathValid_Event__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(nav2_msgs__srv__IsPathValid_Event)) {
      return false;
    }
  ...
  nav2_msgs__srv__IsPathValid_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(nav2_msgs__srv__IsPathValid_Event)) {
      return false;
    }
    const size_t allocation_size =
