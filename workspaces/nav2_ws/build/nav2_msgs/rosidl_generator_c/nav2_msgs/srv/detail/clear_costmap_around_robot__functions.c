...
nav2_msgs__srv__ClearCostmapAroundRobot_Request__Sequence__init(nav2_msgs__srv__ClearCostmapAroundRobot_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(nav2_msgs__srv__ClearCostmapAroundRobot_Request)) {
      return false;
    }
  ...
  nav2_msgs__srv__ClearCostmapAroundRobot_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(nav2_msgs__srv__ClearCostmapAroundRobot_Request)) {
      return false;
    }
...
nav2_msgs__srv__ClearCostmapAroundRobot_Response__Sequence__init(nav2_msgs__srv__ClearCostmapAroundRobot_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(nav2_msgs__srv__ClearCostmapAroundRobot_Response)) {
      return false;
    }
  ...
  nav2_msgs__srv__ClearCostmapAroundRobot_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(nav2_msgs__srv__ClearCostmapAroundRobot_Response)) {
      return false;
    }
    const size_t allocation_size =
...
nav2_msgs__srv__ClearCostmapAroundRobot_Event__Sequence__init(nav2_msgs__srv__ClearCostmapAroundRobot_Event__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(nav2_msgs__srv__ClearCostmapAroundRobot_Event)) {
      return false;
    }
  ...
  nav2_msgs__srv__ClearCostmapAroundRobot_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(nav2_msgs__srv__ClearCostmapAroundRobot_Event)) {
      return false;
    }
    const size_t allocation_size =
