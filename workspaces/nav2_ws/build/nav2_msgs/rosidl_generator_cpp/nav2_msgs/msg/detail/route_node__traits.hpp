...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::msg::RouteNode>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).nodeid,
...
template<>
constexpr const char * data_type<nav2_msgs::msg::RouteNode>()
{
  return "nav2_msgs::msg::RouteNode";
}

template<>
constexpr const char * name<nav2_msgs::msg::RouteNode>()
{
  return "nav2_msgs/msg/RouteNode";
}
...
template<>
struct MessageTraits<nav2_msgs::msg::RouteNode>
{
