...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::msg::SpeedLimit>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).header,
    std::forward<T>(msg).percentage,
    std::forward<T>(msg).speed_limit);
}
...
template<>
constexpr const char * data_type<nav2_msgs::msg::SpeedLimit>()
{
  return "nav2_msgs::msg::SpeedLimit";
}

template<>
constexpr const char * name<nav2_msgs::msg::SpeedLimit>()
{
  return "nav2_msgs/msg/SpeedLimit";
}
...
template<>
struct MessageTraits<nav2_msgs::msg::SpeedLimit>
{
