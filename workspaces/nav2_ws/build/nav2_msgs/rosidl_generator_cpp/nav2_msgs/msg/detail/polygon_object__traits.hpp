...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::msg::PolygonObject>, int> = 0>
...
template<>
constexpr const char * data_type<nav2_msgs::msg::PolygonObject>()
{
  return "nav2_msgs::msg::PolygonObject";
}

template<>
constexpr const char * name<nav2_msgs::msg::PolygonObject>()
{
  return "nav2_msgs/msg/PolygonObject";
}
...
template<>
struct MessageTraits<nav2_msgs::msg::PolygonObject>
{
