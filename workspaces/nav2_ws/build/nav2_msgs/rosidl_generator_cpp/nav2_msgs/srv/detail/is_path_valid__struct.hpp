...
struct IsPathValid_Request_
{
  ...
  : path(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::DEFAULTS_ONLY == _init)
    {
      ...
      this->layer_name = "";
      this->footprint = "";
      this->stop_at_first_collision = true;
      this->max_lookahead_distance = -1.0;
    } else if (rosidl_runtime_cpp::MessageInitialization::ZERO == _init) {
      this->max_cost = 0;
      this->consider_unknown_as_obstacle = false;
      this->layer_name = "";
      this->footprint = "";
      this->stop_at_first_collision = false;
      this->max_lookahead_distance = 0.0;
    }
  }
  ...
  using _stop_at_first_collision_type =
    bool;
  _stop_at_first_collision_type stop_at_first_collision;
  using _max_lookahead_distance_type =
    double;
  _max_lookahead_distance_type max_lookahead_distance;
  ...
  Type & set__stop_at_first_collision(
    const bool & _arg)
  {
    this->stop_at_first_collision = _arg;
    return *this;
  }
  Type & set__max_lookahead_distance(
    const double & _arg)
  {
    this->max_lookahead_distance = _arg;
    return *this;
  }
  ...
  bool operator==(const IsPathValid_Request_ & other) const
  {
    ...
    if (this->stop_at_first_collision != other.stop_at_first_collision) {
      return false;
    }
    if (this->max_lookahead_distance != other.max_lookahead_distance) {
      return false;
    }
    return true;
  }
