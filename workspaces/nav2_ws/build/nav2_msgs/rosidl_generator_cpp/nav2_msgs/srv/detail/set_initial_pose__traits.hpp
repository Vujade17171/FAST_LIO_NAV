...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::SetInitialPose_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).pose);
}
...
template<>
constexpr const char * data_type<nav2_msgs::srv::SetInitialPose_Request>()
{
  return "nav2_msgs::srv::SetInitialPose_Request";
}

template<>
constexpr const char * name<nav2_msgs::srv::SetInitialPose_Request>()
{
  return "nav2_msgs/srv/SetInitialPose_Request";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::SetInitialPose_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::SetInitialPose_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::SetInitialPose_Response>()
{
  return "nav2_msgs::srv::SetInitialPose_Response";
}

template<>
constexpr const char * name<nav2_msgs::srv::SetInitialPose_Response>()
{
  return "nav2_msgs/srv/SetInitialPose_Response";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::SetInitialPose_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::SetInitialPose_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::SetInitialPose_Event>()
{
  return "nav2_msgs::srv::SetInitialPose_Event";
}

template<>
constexpr const char * name<nav2_msgs::srv::SetInitialPose_Event>()
{
  return "nav2_msgs/srv/SetInitialPose_Event";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::SetInitialPose_Event>
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::SetInitialPose>()
{
  return "nav2_msgs::srv::SetInitialPose";
}

template<>
constexpr const char * name<nav2_msgs::srv::SetInitialPose>()
{
  return "nav2_msgs/srv/SetInitialPose";
}
