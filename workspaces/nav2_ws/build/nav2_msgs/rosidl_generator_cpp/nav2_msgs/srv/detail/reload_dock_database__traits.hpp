...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::ReloadDockDatabase_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).filepath);
}
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ReloadDockDatabase_Request>()
{
  return "nav2_msgs::srv::ReloadDockDatabase_Request";
}

template<>
constexpr const char * name<nav2_msgs::srv::ReloadDockDatabase_Request>()
{
  return "nav2_msgs/srv/ReloadDockDatabase_Request";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::ReloadDockDatabase_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::ReloadDockDatabase_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ReloadDockDatabase_Response>()
{
  return "nav2_msgs::srv::ReloadDockDatabase_Response";
}

template<>
constexpr const char * name<nav2_msgs::srv::ReloadDockDatabase_Response>()
{
  return "nav2_msgs/srv/ReloadDockDatabase_Response";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::ReloadDockDatabase_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "success",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::ReloadDockDatabase_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ReloadDockDatabase_Event>()
{
  return "nav2_msgs::srv::ReloadDockDatabase_Event";
}

template<>
constexpr const char * name<nav2_msgs::srv::ReloadDockDatabase_Event>()
{
  return "nav2_msgs/srv/ReloadDockDatabase_Event";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::ReloadDockDatabase_Event>
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ReloadDockDatabase>()
{
  return "nav2_msgs::srv::ReloadDockDatabase";
}

template<>
constexpr const char * name<nav2_msgs::srv::ReloadDockDatabase>()
{
  return "nav2_msgs/srv/ReloadDockDatabase";
}
