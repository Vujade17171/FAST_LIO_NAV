...
class Init_ClearEntireCostmap_Request_plugins
{
public:
  Init_ClearEntireCostmap_Request_plugins()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::nav2_msgs::srv::ClearEntireCostmap_Request plugins(::nav2_msgs::srv::ClearEntireCostmap_Request::_plugins_type arg)
  {
...
{
  return nav2_msgs::srv::builder::Init_ClearEntireCostmap_Request_plugins();
}
...
class Init_ClearEntireCostmap_Response_success
{
public:
  Init_ClearEntireCostmap_Response_success()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::nav2_msgs::srv::ClearEntireCostmap_Response success(::nav2_msgs::srv::ClearEntireCostmap_Response::_success_type arg)
  {
...
{
  return nav2_msgs::srv::builder::Init_ClearEntireCostmap_Response_success();
}
