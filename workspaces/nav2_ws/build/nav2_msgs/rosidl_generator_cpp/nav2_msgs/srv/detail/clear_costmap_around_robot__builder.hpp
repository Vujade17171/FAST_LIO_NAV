...
class Init_ClearCostmapAroundRobot_Request_plugins
{
public:
  explicit Init_ClearCostmapAroundRobot_Request_plugins(::nav2_msgs::srv::ClearCostmapAroundRobot_Request & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::srv::ClearCostmapAroundRobot_Request plugins(::nav2_msgs::srv::ClearCostmapAroundRobot_Request::_plugins_type arg)
  {
...
public:
  ...
  {}
  Init_ClearCostmapAroundRobot_Request_plugins reset_distance(::nav2_msgs::srv::ClearCostmapAroundRobot_Request::_reset_distance_type arg)
  {
    msg_.reset_distance = std::move(arg);
    return Init_ClearCostmapAroundRobot_Request_plugins(msg_);
  }
...
class Init_ClearCostmapAroundRobot_Response_success
{
public:
  Init_ClearCostmapAroundRobot_Response_success()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::nav2_msgs::srv::ClearCostmapAroundRobot_Response success(::nav2_msgs::srv::ClearCostmapAroundRobot_Response::_success_type arg)
  {
...
{
  return nav2_msgs::srv::builder::Init_ClearCostmapAroundRobot_Response_success();
}
