...
class Init_IsPathValid_Request_max_lookahead_distance
{
public:
  explicit Init_IsPathValid_Request_max_lookahead_distance(::nav2_msgs::srv::IsPathValid_Request & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::srv::IsPathValid_Request max_lookahead_distance(::nav2_msgs::srv::IsPathValid_Request::_max_lookahead_distance_type arg)
  {
    msg_.max_lookahead_distance = std::move(arg);
...
class Init_IsPathValid_Request_stop_at_first_collision
{
public:
  explicit Init_IsPathValid_Request_stop_at_first_collision(::nav2_msgs::srv::IsPathValid_Request & msg)
  : msg_(msg)
  {}
  Init_IsPathValid_Request_max_lookahead_distance stop_at_first_collision(::nav2_msgs::srv::IsPathValid_Request::_stop_at_first_collision_type arg)
  {
    msg_.stop_at_first_collision = std::move(arg);
    return Init_IsPathValid_Request_max_lookahead_distance(msg_);
  }
...
class Init_IsPathValid_Request_footprint
{
public:
  explicit Init_IsPathValid_Request_footprint(::nav2_msgs::srv::IsPathValid_Request & msg)
  : msg_(msg)
  {}
  Init_IsPathValid_Request_stop_at_first_collision footprint(::nav2_msgs::srv::IsPathValid_Request::_footprint_type arg)
  {
    msg_.footprint = std::move(arg);
    return Init_IsPathValid_Request_stop_at_first_collision(msg_);
  }
...
class Init_IsPathValid_Request_layer_name
{
public:
  explicit Init_IsPathValid_Request_layer_name(::nav2_msgs::srv::IsPathValid_Request & msg)
  : msg_(msg)
  {}
  Init_IsPathValid_Request_footprint layer_name(::nav2_msgs::srv::IsPathValid_Request::_layer_name_type arg)
  {
    msg_.layer_name = std::move(arg);
    return Init_IsPathValid_Request_footprint(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_IsPathValid_Request_layer_name consider_unknown_as_obstacle(::nav2_msgs::srv::IsPathValid_Request::_consider_unknown_as_obstacle_type arg)
  {
    msg_.consider_unknown_as_obstacle = std::move(arg);
    return Init_IsPathValid_Request_layer_name(msg_);
  }
...
{
public:
  explicit Init_IsPathValid_Response_is_valid(::nav2_msgs::srv::IsPathValid_Response & msg)
  : msg_(msg)
  {}
...
class Init_IsPathValid_Response_success
{
public:
  Init_IsPathValid_Response_success()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_IsPathValid_Response_is_valid success(::nav2_msgs::srv::IsPathValid_Response::_success_type arg)
  {
    msg_.success = std::move(arg);
    return Init_IsPathValid_Response_is_valid(msg_);
  }
...
{
  return nav2_msgs::srv::builder::Init_IsPathValid_Response_success();
}
