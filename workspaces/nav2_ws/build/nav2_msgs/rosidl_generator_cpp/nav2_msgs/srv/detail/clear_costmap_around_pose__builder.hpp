...
class Init_ClearCostmapAroundPose_Request_plugins
{
public:
  explicit Init_ClearCostmapAroundPose_Request_plugins(::nav2_msgs::srv::ClearCostmapAroundPose_Request & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::srv::ClearCostmapAroundPose_Request plugins(::nav2_msgs::srv::ClearCostmapAroundPose_Request::_plugins_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_ClearCostmapAroundPose_Request_plugins reset_distance(::nav2_msgs::srv::ClearCostmapAroundPose_Request::_reset_distance_type arg)
  {
    msg_.reset_distance = std::move(arg);
    return Init_ClearCostmapAroundPose_Request_plugins(msg_);
  }
...
class Init_ClearCostmapAroundPose_Response_success
{
public:
  Init_ClearCostmapAroundPose_Response_success()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::nav2_msgs::srv::ClearCostmapAroundPose_Response success(::nav2_msgs::srv::ClearCostmapAroundPose_Response::_success_type arg)
  {
...
{
  return nav2_msgs::srv::builder::Init_ClearCostmapAroundPose_Response_success();
}
