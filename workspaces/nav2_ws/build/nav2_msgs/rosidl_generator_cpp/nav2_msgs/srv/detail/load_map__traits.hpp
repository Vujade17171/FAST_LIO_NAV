...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::LoadMap_Request>, int> = 0>
...
template<>
constexpr const char * data_type<nav2_msgs::srv::LoadMap_Request>()
{
  return "nav2_msgs::srv::LoadMap_Request";
}

template<>
constexpr const char * name<nav2_msgs::srv::LoadMap_Request>()
{
  return "nav2_msgs/srv/LoadMap_Request";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::LoadMap_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::LoadMap_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::LoadMap_Response>()
{
  return "nav2_msgs::srv::LoadMap_Response";
}

template<>
constexpr const char * name<nav2_msgs::srv::LoadMap_Response>()
{
  return "nav2_msgs/srv/LoadMap_Response";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::LoadMap_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::LoadMap_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::srv::LoadMap_Event>()
{
  return "nav2_msgs::srv::LoadMap_Event";
}

template<>
constexpr const char * name<nav2_msgs::srv::LoadMap_Event>()
{
  return "nav2_msgs/srv/LoadMap_Event";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::LoadMap_Event>
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::LoadMap>()
{
  return "nav2_msgs::srv::LoadMap";
}

template<>
constexpr const char * name<nav2_msgs::srv::LoadMap>()
{
  return "nav2_msgs/srv/LoadMap";
}
