...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::ClearCostmapAroundRobot_Request>, int> = 0>
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ClearCostmapAroundRobot_Request>()
{
  return "nav2_msgs::srv::ClearCostmapAroundRobot_Request";
}

template<>
constexpr const char * name<nav2_msgs::srv::ClearCostmapAroundRobot_Request>()
{
  return "nav2_msgs/srv/ClearCostmapAroundRobot_Request";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::ClearCostmapAroundRobot_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::ClearCostmapAroundRobot_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ClearCostmapAroundRobot_Response>()
{
  return "nav2_msgs::srv::ClearCostmapAroundRobot_Response";
}

template<>
constexpr const char * name<nav2_msgs::srv::ClearCostmapAroundRobot_Response>()
{
  return "nav2_msgs/srv/ClearCostmapAroundRobot_Response";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::ClearCostmapAroundRobot_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::ClearCostmapAroundRobot_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ClearCostmapAroundRobot_Event>()
{
  return "nav2_msgs::srv::ClearCostmapAroundRobot_Event";
}

template<>
constexpr const char * name<nav2_msgs::srv::ClearCostmapAroundRobot_Event>()
{
  return "nav2_msgs/srv/ClearCostmapAroundRobot_Event";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::ClearCostmapAroundRobot_Event>
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ClearCostmapAroundRobot>()
{
  return "nav2_msgs::srv::ClearCostmapAroundRobot";
}

template<>
constexpr const char * name<nav2_msgs::srv::ClearCostmapAroundRobot>()
{
  return "nav2_msgs/srv/ClearCostmapAroundRobot";
}
