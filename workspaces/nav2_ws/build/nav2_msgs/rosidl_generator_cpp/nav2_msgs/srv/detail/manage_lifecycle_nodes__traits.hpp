...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::ManageLifecycleNodes_Request>, int> = 0>
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ManageLifecycleNodes_Request>()
{
  return "nav2_msgs::srv::ManageLifecycleNodes_Request";
}

template<>
constexpr const char * name<nav2_msgs::srv::ManageLifecycleNodes_Request>()
{
  return "nav2_msgs/srv/ManageLifecycleNodes_Request";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::ManageLifecycleNodes_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::ManageLifecycleNodes_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ManageLifecycleNodes_Response>()
{
  return "nav2_msgs::srv::ManageLifecycleNodes_Response";
}

template<>
constexpr const char * name<nav2_msgs::srv::ManageLifecycleNodes_Response>()
{
  return "nav2_msgs/srv/ManageLifecycleNodes_Response";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::ManageLifecycleNodes_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "success",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::srv::ManageLifecycleNodes_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ManageLifecycleNodes_Event>()
{
  return "nav2_msgs::srv::ManageLifecycleNodes_Event";
}

template<>
constexpr const char * name<nav2_msgs::srv::ManageLifecycleNodes_Event>()
{
  return "nav2_msgs/srv/ManageLifecycleNodes_Event";
}
...
template<>
struct MessageTraits<nav2_msgs::srv::ManageLifecycleNodes_Event>
{
...
template<>
constexpr const char * data_type<nav2_msgs::srv::ManageLifecycleNodes>()
{
  return "nav2_msgs::srv::ManageLifecycleNodes";
}

template<>
constexpr const char * name<nav2_msgs::srv::ManageLifecycleNodes>()
{
  return "nav2_msgs/srv/ManageLifecycleNodes";
}
