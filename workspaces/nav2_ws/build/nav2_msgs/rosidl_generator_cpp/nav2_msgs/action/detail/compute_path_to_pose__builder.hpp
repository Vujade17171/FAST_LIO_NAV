...
class Init_ComputePathToPose_Goal_viapoints
{
public:
  explicit Init_ComputePathToPose_Goal_viapoints(::nav2_msgs::action::ComputePathToPose_Goal & msg)
  : msg_(msg)
  {}
  Init_ComputePathToPose_Goal_planner_id viapoints(::nav2_msgs::action::ComputePathToPose_Goal::_viapoints_type arg)
  {
    msg_.viapoints = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_ComputePathToPose_Goal_viapoints start(::nav2_msgs::action::ComputePathToPose_Goal::_start_type arg)
  {
    msg_.start = std::move(arg);
    return Init_ComputePathToPose_Goal_viapoints(msg_);
  }
