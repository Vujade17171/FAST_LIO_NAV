...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_Goal>, int> = 0>
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_Goal>()
{
  return "nav2_msgs::action::Wait_Goal";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_Goal>()
{
  return "nav2_msgs/action/Wait_Goal";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_Goal>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_Result>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_Result>()
{
  return "nav2_msgs::action::Wait_Result";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_Result>()
{
  return "nav2_msgs/action/Wait_Result";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_Result>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_Feedback>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).time_left);
}
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_Feedback>()
{
  return "nav2_msgs::action::Wait_Feedback";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_Feedback>()
{
  return "nav2_msgs/action/Wait_Feedback";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_Feedback>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "time_left",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_SendGoal_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_SendGoal_Request>()
{
  return "nav2_msgs::action::Wait_SendGoal_Request";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_SendGoal_Request>()
{
  return "nav2_msgs/action/Wait_SendGoal_Request";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_SendGoal_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_SendGoal_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_SendGoal_Response>()
{
  return "nav2_msgs::action::Wait_SendGoal_Response";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_SendGoal_Response>()
{
  return "nav2_msgs/action/Wait_SendGoal_Response";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_SendGoal_Response>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "accepted",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_SendGoal_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_SendGoal_Event>()
{
  return "nav2_msgs::action::Wait_SendGoal_Event";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_SendGoal_Event>()
{
  return "nav2_msgs/action/Wait_SendGoal_Event";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_SendGoal_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_SendGoal>()
{
  return "nav2_msgs::action::Wait_SendGoal";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_SendGoal>()
{
  return "nav2_msgs/action/Wait_SendGoal";
}
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_GetResult_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_GetResult_Request>()
{
  return "nav2_msgs::action::Wait_GetResult_Request";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_GetResult_Request>()
{
  return "nav2_msgs/action/Wait_GetResult_Request";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_GetResult_Request>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "goal_id",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_GetResult_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_GetResult_Response>()
{
  return "nav2_msgs::action::Wait_GetResult_Response";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_GetResult_Response>()
{
  return "nav2_msgs/action/Wait_GetResult_Response";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_GetResult_Response>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "status",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_GetResult_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).info,
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_GetResult_Event>()
{
  return "nav2_msgs::action::Wait_GetResult_Event";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_GetResult_Event>()
{
  return "nav2_msgs/action/Wait_GetResult_Event";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_GetResult_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_GetResult>()
{
  return "nav2_msgs::action::Wait_GetResult";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_GetResult>()
{
  return "nav2_msgs/action/Wait_GetResult";
}
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::Wait_FeedbackMessage>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).goal_id,
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait_FeedbackMessage>()
{
  return "nav2_msgs::action::Wait_FeedbackMessage";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait_FeedbackMessage>()
{
  return "nav2_msgs/action/Wait_FeedbackMessage";
}
...
template<>
struct MessageTraits<nav2_msgs::action::Wait_FeedbackMessage>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "goal_id",
...
template<>
constexpr const char * data_type<nav2_msgs::action::Wait>()
{
  return "nav2_msgs::action::Wait";
}

template<>
constexpr const char * name<nav2_msgs::action::Wait>()
{
  return "nav2_msgs/action/Wait";
}
