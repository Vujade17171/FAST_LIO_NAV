...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_Goal>, int> = 0>
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_Goal>()
{
  return "nav2_msgs::action::FollowWaypoints_Goal";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_Goal>()
{
  return "nav2_msgs/action/FollowWaypoints_Goal";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_Goal>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_Result>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_Result>()
{
  return "nav2_msgs::action::FollowWaypoints_Result";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_Result>()
{
  return "nav2_msgs/action/FollowWaypoints_Result";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_Result>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "missed_waypoints",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_Feedback>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_Feedback>()
{
  return "nav2_msgs::action::FollowWaypoints_Feedback";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_Feedback>()
{
  return "nav2_msgs/action/FollowWaypoints_Feedback";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_Feedback>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_SendGoal_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_SendGoal_Request>()
{
  return "nav2_msgs::action::FollowWaypoints_SendGoal_Request";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_SendGoal_Request>()
{
  return "nav2_msgs/action/FollowWaypoints_SendGoal_Request";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_SendGoal_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_SendGoal_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_SendGoal_Response>()
{
  return "nav2_msgs::action::FollowWaypoints_SendGoal_Response";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_SendGoal_Response>()
{
  return "nav2_msgs/action/FollowWaypoints_SendGoal_Response";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_SendGoal_Response>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "accepted",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_SendGoal_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_SendGoal_Event>()
{
  return "nav2_msgs::action::FollowWaypoints_SendGoal_Event";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_SendGoal_Event>()
{
  return "nav2_msgs/action/FollowWaypoints_SendGoal_Event";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_SendGoal_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_SendGoal>()
{
  return "nav2_msgs::action::FollowWaypoints_SendGoal";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_SendGoal>()
{
  return "nav2_msgs/action/FollowWaypoints_SendGoal";
}
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_GetResult_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_GetResult_Request>()
{
  return "nav2_msgs::action::FollowWaypoints_GetResult_Request";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_GetResult_Request>()
{
  return "nav2_msgs/action/FollowWaypoints_GetResult_Request";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_GetResult_Request>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "goal_id",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_GetResult_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_GetResult_Response>()
{
  return "nav2_msgs::action::FollowWaypoints_GetResult_Response";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_GetResult_Response>()
{
  return "nav2_msgs/action/FollowWaypoints_GetResult_Response";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_GetResult_Response>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "status",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_GetResult_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).info,
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_GetResult_Event>()
{
  return "nav2_msgs::action::FollowWaypoints_GetResult_Event";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_GetResult_Event>()
{
  return "nav2_msgs/action/FollowWaypoints_GetResult_Event";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_GetResult_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_GetResult>()
{
  return "nav2_msgs::action::FollowWaypoints_GetResult";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_GetResult>()
{
  return "nav2_msgs/action/FollowWaypoints_GetResult";
}
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav2_msgs::action::FollowWaypoints_FeedbackMessage>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).goal_id,
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints_FeedbackMessage>()
{
  return "nav2_msgs::action::FollowWaypoints_FeedbackMessage";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints_FeedbackMessage>()
{
  return "nav2_msgs/action/FollowWaypoints_FeedbackMessage";
}
...
template<>
struct MessageTraits<nav2_msgs::action::FollowWaypoints_FeedbackMessage>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "goal_id",
...
template<>
constexpr const char * data_type<nav2_msgs::action::FollowWaypoints>()
{
  return "nav2_msgs::action::FollowWaypoints";
}

template<>
constexpr const char * name<nav2_msgs::action::FollowWaypoints>()
{
  return "nav2_msgs/action/FollowWaypoints";
}
