...
class Init_FollowPath_Goal_path_handler_id
{
public:
  explicit Init_FollowPath_Goal_path_handler_id(::nav2_msgs::action::FollowPath_Goal & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::FollowPath_Goal path_handler_id(::nav2_msgs::action::FollowPath_Goal::_path_handler_id_type arg)
  {
    msg_.path_handler_id = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_FollowPath_Goal_path_handler_id progress_checker_id(::nav2_msgs::action::FollowPath_Goal::_progress_checker_id_type arg)
  {
    msg_.progress_checker_id = std::move(arg);
    return Init_FollowPath_Goal_path_handler_id(msg_);
  }
