...
class Init_NavigateToPose_Feedback_heading_tracking_error
{
public:
  explicit Init_NavigateToPose_Feedback_heading_tracking_error(::nav2_msgs::action::NavigateToPose_Feedback & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::NavigateToPose_Feedback heading_tracking_error(::nav2_msgs::action::NavigateToPose_Feedback::_heading_tracking_error_type arg)
  {
...
class Init_NavigateToPose_Feedback_position_tracking_error
{
public:
  explicit Init_NavigateToPose_Feedback_position_tracking_error(::nav2_msgs::action::NavigateToPose_Feedback & msg)
  : msg_(msg)
  {}
  Init_NavigateToPose_Feedback_heading_tracking_error position_tracking_error(::nav2_msgs::action::NavigateToPose_Feedback::_position_tracking_error_type arg)
  {
    msg_.position_tracking_error = std::move(arg);
    return Init_NavigateToPose_Feedback_heading_tracking_error(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_NavigateToPose_Feedback_position_tracking_error distance_remaining(::nav2_msgs::action::NavigateToPose_Feedback::_distance_remaining_type arg)
  {
    msg_.distance_remaining = std::move(arg);
    return Init_NavigateToPose_Feedback_position_tracking_error(msg_);
  }
