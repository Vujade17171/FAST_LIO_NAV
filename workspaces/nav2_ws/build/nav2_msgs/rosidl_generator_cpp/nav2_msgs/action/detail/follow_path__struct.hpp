...
struct FollowPath_Goal_
{
  ...
  using _path_handler_id_type =
    std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
  _path_handler_id_type path_handler_id;
  ...
  Type & set__path_handler_id(
    const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> & _arg)
  {
    this->path_handler_id = _arg;
    return *this;
  }
  ...
  bool operator==(const FollowPath_Goal_ & other) const
  {
    ...
    if (this->path_handler_id != other.path_handler_id) {
      return false;
    }
    return true;
  }
...
struct FollowPath_Result_
{
  ...
  static constexpr uint16_t NONE =
    0u;
  static constexpr uint16_t GOAL_REJECTED =
    1u;
  static constexpr uint16_t SEND_GOAL_FAILURE =
    2u;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::GOAL_REJECTED;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::SEND_GOAL_FAILURE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::TIMEOUT;
#endif  // __cplusplus < 201703L
