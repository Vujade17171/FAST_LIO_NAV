...
static bool _CostmapUpdate__cdr_serialize_with_endpoint(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr,
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  const nav2_msgs__msg__CostmapUpdate * ros_message =
    static_cast<const nav2_msgs__msg__CostmapUpdate *>(untyped_ros_message);
  (void)endpoint_info;
  // Field name: header
  // Field name: header
  {
...
static bool _CostmapUpdate__cdr_deserialize_with_endpoint(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  nav2_msgs__msg__CostmapUpdate * ros_message =
    static_cast<nav2_msgs__msg__CostmapUpdate *>(untyped_ros_message);
  (void)endpoint_info;
  // Field name: header
  // Field name: header
  {
...
static message_type_support_callbacks_t __callbacks_CostmapUpdate = {
  ...
  nullptr,
  true,
  _CostmapUpdate__cdr_serialize_with_endpoint,
  _CostmapUpdate__cdr_deserialize_with_endpoint
};
