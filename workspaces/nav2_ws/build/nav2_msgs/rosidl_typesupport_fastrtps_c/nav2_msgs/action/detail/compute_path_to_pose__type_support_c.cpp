...
#include "geometry_msgs/msg/detail/pose_stamped__functions.h"  // goal, start, viapoints
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: viapoints
  {
    size_t size = ros_message->viapoints.size;
    auto array_ptr = ros_message->viapoints.data;
  ...
  nav2_msgs__action__ComputePathToPose_Goal * ros_message)
{
  ...
  // Field name: viapoints
  {
    ...
    if (ros_message->viapoints.data) {
      geometry_msgs__msg__PoseStamped__Sequence__fini(&ros_message->viapoints);
    }
    if (!geometry_msgs__msg__PoseStamped__Sequence__init(&ros_message->viapoints, size)) {
      fprintf(stderr, "failed to create array for field 'viapoints'");
      return false;
    }
    auto array_ptr = ros_message->viapoints.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // Field name: viapoints
  {
    size_t array_size = ros_message->viapoints.size;
    auto array_ptr = ros_message->viapoints.data;
