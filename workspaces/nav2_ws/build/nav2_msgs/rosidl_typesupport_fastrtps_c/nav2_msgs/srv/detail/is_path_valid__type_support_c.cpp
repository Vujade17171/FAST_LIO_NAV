...
#include "rosidl_runtime_c/string.h"  // footprint, layer_name
#include "rosidl_runtime_c/string_functions.h"  // footprint, layer_name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: stop_at_first_collision
  {
    cdr << (ros_message->stop_at_first_collision ? true : false);
  }

  // Field name: max_lookahead_distance
  {
    cdr << ros_message->max_lookahead_distance;
  }
  ...
  nav2_msgs__srv__IsPathValid_Request * ros_message)
{
  ...
  // Field name: stop_at_first_collision
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->stop_at_first_collision = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: stop_at_first_collision
  {
    size_t item_size = sizeof(ros_message->stop_at_first_collision);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Field name: max_lookahead_distance
  {
    size_t item_size = sizeof(ros_message->max_lookahead_distance);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, max_lookahead_distance) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
