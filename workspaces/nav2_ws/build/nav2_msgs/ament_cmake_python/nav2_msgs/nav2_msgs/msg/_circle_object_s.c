...
bool nav2_msgs__msg__circle_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._circle_object", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("CircleObject", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);
