...
bool nav2_msgs__msg__costmap_meta_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._costmap_meta_data", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("CostmapMetaData", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
