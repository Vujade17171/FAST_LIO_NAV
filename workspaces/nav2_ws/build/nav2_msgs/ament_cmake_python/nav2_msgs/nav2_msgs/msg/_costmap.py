...
class Metaclass_Costmap(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class CostmapConstants(typing.TypedDict):
        pass

    __constants: CostmapConstants = {
    }
...
class Costmap(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Costmap):
    ...
    def __init__(self, *,
                 ...
                 metadata: typing.Optional[nav2_msgs.msg.CostmapMetaData] = None,  # noqa: E501
        ...
        from nav2_msgs.msg import CostmapMetaData
        self.metadata = metadata if metadata is not None else CostmapMetaData()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, Costmap):
            return False
    ...
    @builtins.property
    def metadata(self) -> nav2_msgs.msg.CostmapMetaData:
        """Message field 'metadata'."""
        return self._metadata

    @metadata.setter
    def metadata(self, value: nav2_msgs.msg.CostmapMetaData) -> None:
        from nav2_msgs.msg import CostmapMetaData
