...
class Metaclass_CostmapFilterInfo(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class CostmapFilterInfoConstants(typing.TypedDict):
        pass

    __constants: CostmapFilterInfoConstants = {
    }
...
class CostmapFilterInfo(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_CostmapFilterInfo):
    ...
    def __init__(self, *,
                 ...
                 filter_mask_topic: typing.Optional[str] = None,  # noqa: E501
                 base: typing.Optional[float] = None,  # noqa: E501
                 multiplier: typing.Optional[float] = None,  # noqa: E501
        ...
        self.filter_mask_topic = filter_mask_topic if filter_mask_topic is not None else str()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, CostmapFilterInfo):
            return False
