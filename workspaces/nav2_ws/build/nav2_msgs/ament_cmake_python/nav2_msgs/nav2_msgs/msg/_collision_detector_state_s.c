...
bool nav2_msgs__msg__collision_detector_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._collision_detector_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("CollisionDetectorState", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
