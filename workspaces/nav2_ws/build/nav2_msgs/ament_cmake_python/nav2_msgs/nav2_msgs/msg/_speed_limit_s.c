...
bool nav2_msgs__msg__speed_limit__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._speed_limit", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("SpeedLimit", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
