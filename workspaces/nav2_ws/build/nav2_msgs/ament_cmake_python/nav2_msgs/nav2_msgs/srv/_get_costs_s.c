...
bool nav2_msgs__srv__get_costs__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.srv._get_costs", (char *)PyUnicode_1BYTE_DATA(module_attr), 24) == 0);
    assert(strncmp("GetCosts_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
...
bool nav2_msgs__srv__get_costs__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.srv._get_costs", (char *)PyUnicode_1BYTE_DATA(module_attr), 24) == 0);
    assert(strncmp("GetCosts_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
...
bool nav2_msgs__srv__get_costs__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.srv._get_costs", (char *)PyUnicode_1BYTE_DATA(module_attr), 24) == 0);
    assert(strncmp("GetCosts_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
