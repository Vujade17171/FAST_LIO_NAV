...
bool nav2_msgs__srv__get_costmap__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.srv._get_costmap", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("GetCostmap_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
...
bool nav2_msgs__srv__get_costmap__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.srv._get_costmap", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("GetCostmap_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
...
bool nav2_msgs__srv__get_costmap__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.srv._get_costmap", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("GetCostmap_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
