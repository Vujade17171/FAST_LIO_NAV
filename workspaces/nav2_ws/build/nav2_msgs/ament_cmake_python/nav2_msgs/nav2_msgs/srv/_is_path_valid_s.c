...
bool nav2_msgs__srv__is_path_valid__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.srv._is_path_valid", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("IsPathValid_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
  ...
  {  // stop_at_first_collision
    PyObject * field = PyObject_GetAttrString(_pymsg, "stop_at_first_collision");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->stop_at_first_collision = (Py_True == field);
    Py_DECREF(field);
  }
  {  // max_lookahead_distance
    PyObject * field = PyObject_GetAttrString(_pymsg, "max_lookahead_distance");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->max_lookahead_distance = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * nav2_msgs__srv__is_path_valid__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // stop_at_first_collision
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->stop_at_first_collision ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "stop_at_first_collision", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // max_lookahead_distance
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->max_lookahead_distance);
    {
      int rc = PyObject_SetAttrString(_pymessage, "max_lookahead_distance", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
bool nav2_msgs__srv__is_path_valid__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.srv._is_path_valid", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("IsPathValid_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);
...
bool nav2_msgs__srv__is_path_valid__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.srv._is_path_valid", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("IsPathValid_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
