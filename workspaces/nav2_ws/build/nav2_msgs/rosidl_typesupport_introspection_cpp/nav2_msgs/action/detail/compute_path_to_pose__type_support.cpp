...
size_t size_function__ComputePathToPose_Goal__viapoints(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<geometry_msgs::msg::PoseStamped> *>(untyped_member);
  return member->size();
}

const void * get_const_function__ComputePathToPose_Goal__viapoints(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__ComputePathToPose_Goal__viapoints(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__ComputePathToPose_Goal__viapoints(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::PoseStamped *>(
    get_const_function__ComputePathToPose_Goal__viapoints(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::PoseStamped *>(untyped_value);
  value = item;
}

void assign_function__ComputePathToPose_Goal__viapoints(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::PoseStamped *>(
    get_function__ComputePathToPose_Goal__viapoints(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::PoseStamped *>(untyped_value);
  item = value;
}

void resize_function__ComputePathToPose_Goal__viapoints(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<geometry_msgs::msg::PoseStamped> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ComputePathToPose_Goal_message_member_array[5] = {
  {
    "goal",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs::action::ComputePathToPose_Goal, viapoints),  // bytes offset in struct
    nullptr,  // default value
    size_function__ComputePathToPose_Goal__viapoints,  // size() function pointer
    get_const_function__ComputePathToPose_Goal__viapoints,  // get_const(index) function pointer
    get_function__ComputePathToPose_Goal__viapoints,  // get(index) function pointer
    fetch_function__ComputePathToPose_Goal__viapoints,  // fetch(index, &value) function pointer
    assign_function__ComputePathToPose_Goal__viapoints,  // assign(index, value) function pointer
    resize_function__ComputePathToPose_Goal__viapoints,  // resize(index) function pointer
    false  // is_rosidl_buffer
  },
  {
    "planner_id",  // name
