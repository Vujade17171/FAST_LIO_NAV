...
class Metaclass_CostmapUpdate(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class CostmapUpdateConstants(typing.TypedDict):
        pass

    __constants: CostmapUpdateConstants = {
    }
...
class CostmapUpdate(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_CostmapUpdate):
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, CostmapUpdate):
            return False
