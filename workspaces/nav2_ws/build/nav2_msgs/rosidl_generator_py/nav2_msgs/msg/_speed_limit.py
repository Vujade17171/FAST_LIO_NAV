...
class Metaclass_SpeedLimit(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class SpeedLimitConstants(typing.TypedDict):
        pass

    __constants: SpeedLimitConstants = {
    }
...
class SpeedLimit(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SpeedLimit):
    ...
    def __init__(self, *,
                 ...
                 percentage: typing.Optional[bool] = None,  # noqa: E501
                 speed_limit: typing.Optional[float] = None,  # noqa: E501
        ...
        self.percentage = percentage if percentage is not None else bool()
        self.speed_limit = speed_limit if speed_limit is not None else float()
