...
bool nav2_msgs__msg__collision_monitor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._collision_monitor_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("CollisionMonitorState", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
