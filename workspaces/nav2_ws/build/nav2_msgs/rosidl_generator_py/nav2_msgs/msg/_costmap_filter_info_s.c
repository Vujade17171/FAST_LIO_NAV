...
bool nav2_msgs__msg__costmap_filter_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._costmap_filter_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("CostmapFilterInfo", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
