...
bool nav2_msgs__msg__particle_cloud__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._particle_cloud", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("ParticleCloud", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
