...
bool nav2_msgs__srv__clear_costmap_except_region__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.srv._clear_costmap_except_region", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("ClearCostmapExceptRegion_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 32) == 0);
  ...
  {  // plugins
    ...
    }
    {
      ...
      if (!rosidl_runtime_c__String__Sequence__init(&(ros_message->plugins), size)) {
        PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
      rosidl_runtime_c__String * dest = ros_message->plugins.data;
...
PyObject * nav2_msgs__srv__clear_costmap_except_region__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // plugins
    ...
    rosidl_runtime_c__String * src = ros_message->plugins.data;
...
bool nav2_msgs__srv__clear_costmap_except_region__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.srv._clear_costmap_except_region", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("ClearCostmapExceptRegion_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 33) == 0);
...
bool nav2_msgs__srv__clear_costmap_except_region__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.srv._clear_costmap_except_region", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("ClearCostmapExceptRegion_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 30) == 0);
