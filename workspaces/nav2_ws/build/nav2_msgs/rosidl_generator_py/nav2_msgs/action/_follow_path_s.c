...
bool nav2_msgs__action__follow_path__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_Goal", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
  ...
  {  // path_handler_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "path_handler_id");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->path_handler_id, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
PyObject * nav2_msgs__action__follow_path__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {  // path_handler_id
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->path_handler_id.data,
      strlen(ros_message->path_handler_id.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "path_handler_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
bool nav2_msgs__action__follow_path__result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_Result", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
...
bool nav2_msgs__action__follow_path__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_Feedback", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
...
bool nav2_msgs__action__follow_path__send_goal__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_SendGoal_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 27) == 0);
...
bool nav2_msgs__action__follow_path__send_goal__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_SendGoal_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 28) == 0);
...
bool nav2_msgs__action__follow_path__send_goal__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_SendGoal_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
...
bool nav2_msgs__action__follow_path__get_result__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_GetResult_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 28) == 0);
...
bool nav2_msgs__action__follow_path__get_result__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_GetResult_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 29) == 0);
...
bool nav2_msgs__action__follow_path__get_result__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_GetResult_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 26) == 0);
...
bool nav2_msgs__action__follow_path__feedback_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav2_msgs.action._follow_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("FollowPath_FeedbackMessage", (char *)PyUnicode_1BYTE_DATA(name_attr), 26) == 0);
