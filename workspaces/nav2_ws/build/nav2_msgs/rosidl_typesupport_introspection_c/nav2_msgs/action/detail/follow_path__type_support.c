...
static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__FollowPath_Goal__rosidl_typesupport_introspection_c__FollowPath_Goal_message_member_array[5] = {
  {
    "path",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs__action__FollowPath_Goal, path_handler_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
