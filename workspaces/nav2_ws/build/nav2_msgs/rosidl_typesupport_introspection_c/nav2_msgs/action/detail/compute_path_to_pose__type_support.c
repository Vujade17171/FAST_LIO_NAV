...
size_t nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__size_function__ComputePathToPose_Goal__viapoints(
...
const void * nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__get_const_function__ComputePathToPose_Goal__viapoints(
...
void * nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__get_function__ComputePathToPose_Goal__viapoints(
...
void nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__fetch_function__ComputePathToPose_Goal__viapoints(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const geometry_msgs__msg__PoseStamped * item =
    ((const geometry_msgs__msg__PoseStamped *)
    nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__get_const_function__ComputePathToPose_Goal__viapoints(untyped_member, index));
  geometry_msgs__msg__PoseStamped * value =
    (geometry_msgs__msg__PoseStamped *)(untyped_value);
  *value = *item;
}

void nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__assign_function__ComputePathToPose_Goal__viapoints(
  void * untyped_member, size_t index, const void * untyped_value)
{
  geometry_msgs__msg__PoseStamped * item =
    ((geometry_msgs__msg__PoseStamped *)
    nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__get_function__ComputePathToPose_Goal__viapoints(untyped_member, index));
  const geometry_msgs__msg__PoseStamped * value =
    (const geometry_msgs__msg__PoseStamped *)(untyped_value);
  *item = *value;
}

bool nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__resize_function__ComputePathToPose_Goal__viapoints(
...
static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__ComputePathToPose_Goal_message_member_array[5] = {
  {
    "goal",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs__action__ComputePathToPose_Goal, viapoints),  // bytes offset in struct
    NULL,  // default value
    nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__size_function__ComputePathToPose_Goal__viapoints,  // size() function pointer
    nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__get_const_function__ComputePathToPose_Goal__viapoints,  // get_const(index) function pointer
    nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__get_function__ComputePathToPose_Goal__viapoints,  // get(index) function pointer
    nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__fetch_function__ComputePathToPose_Goal__viapoints,  // fetch(index, &value) function pointer
    nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__assign_function__ComputePathToPose_Goal__viapoints,  // assign(index, value) function pointer
    nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__resize_function__ComputePathToPose_Goal__viapoints,  // resize(index) function pointer
    false  // is_rosidl_buffer
  },
  {
    "planner_id",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, ComputePathToPose_Goal)() {
  ...
  nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__ComputePathToPose_Goal_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, PoseStamped)();
  nav2_msgs__action__ComputePathToPose_Goal__rosidl_typesupport_introspection_c__ComputePathToPose_Goal_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, PoseStamped)();
