...
pub struct DebugLocalPlan_Request {
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub global_plan: nav_msgs::msg::Path,
...
impl rosidl_runtime_rs::Message for DebugLocalPlan_Request {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        global_plan: nav_msgs::msg::Path::into_rmw_message(std::borrow::Cow::Owned(msg.global_plan)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        global_plan: nav_msgs::msg::Path::into_rmw_message(std::borrow::Cow::Borrowed(&msg.global_plan)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      ...
      global_plan: nav_msgs::msg::Path::from_rmw_message(msg.global_plan),
    }
  }
}
