...
bool dwb_msgs__srv__get_critic_score__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dwb_msgs.srv._get_critic_score", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("GetCriticScore_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
...
bool dwb_msgs__srv__get_critic_score__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("dwb_msgs.srv._get_critic_score", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("GetCriticScore_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
...
bool dwb_msgs__srv__get_critic_score__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("dwb_msgs.srv._get_critic_score", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("GetCriticScore_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);
