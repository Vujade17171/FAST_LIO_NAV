...
bool dwb_msgs__srv__generate_trajectory__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dwb_msgs.srv._generate_trajectory", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("GenerateTrajectory_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 26) == 0);
...
bool dwb_msgs__srv__generate_trajectory__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("dwb_msgs.srv._generate_trajectory", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("GenerateTrajectory_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 27) == 0);
...
bool dwb_msgs__srv__generate_trajectory__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("dwb_msgs.srv._generate_trajectory", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("GenerateTrajectory_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 24) == 0);
