...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dwb_msgs::srv::DebugLocalPlan_Request>, int> = 0>
...
template<>
constexpr const char * data_type<dwb_msgs::srv::DebugLocalPlan_Request>()
{
  return "dwb_msgs::srv::DebugLocalPlan_Request";
}

template<>
constexpr const char * name<dwb_msgs::srv::DebugLocalPlan_Request>()
{
  return "dwb_msgs/srv/DebugLocalPlan_Request";
}
...
template<>
struct MessageTraits<dwb_msgs::srv::DebugLocalPlan_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dwb_msgs::srv::DebugLocalPlan_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<dwb_msgs::srv::DebugLocalPlan_Response>()
{
  return "dwb_msgs::srv::DebugLocalPlan_Response";
}

template<>
constexpr const char * name<dwb_msgs::srv::DebugLocalPlan_Response>()
{
  return "dwb_msgs/srv/DebugLocalPlan_Response";
}
...
template<>
struct MessageTraits<dwb_msgs::srv::DebugLocalPlan_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dwb_msgs::srv::DebugLocalPlan_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<dwb_msgs::srv::DebugLocalPlan_Event>()
{
  return "dwb_msgs::srv::DebugLocalPlan_Event";
}

template<>
constexpr const char * name<dwb_msgs::srv::DebugLocalPlan_Event>()
{
  return "dwb_msgs/srv/DebugLocalPlan_Event";
}
...
template<>
struct MessageTraits<dwb_msgs::srv::DebugLocalPlan_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<dwb_msgs::srv::DebugLocalPlan>()
{
  return "dwb_msgs::srv::DebugLocalPlan";
}

template<>
constexpr const char * name<dwb_msgs::srv::DebugLocalPlan>()
{
  return "dwb_msgs/srv/DebugLocalPlan";
}
