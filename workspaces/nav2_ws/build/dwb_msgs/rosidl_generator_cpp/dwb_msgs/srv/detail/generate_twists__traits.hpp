...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dwb_msgs::srv::GenerateTwists_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).current_vel);
}
...
template<>
constexpr const char * data_type<dwb_msgs::srv::GenerateTwists_Request>()
{
  return "dwb_msgs::srv::GenerateTwists_Request";
}

template<>
constexpr const char * name<dwb_msgs::srv::GenerateTwists_Request>()
{
  return "dwb_msgs/srv/GenerateTwists_Request";
}
...
template<>
struct MessageTraits<dwb_msgs::srv::GenerateTwists_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dwb_msgs::srv::GenerateTwists_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).twists);
}
...
template<>
constexpr const char * data_type<dwb_msgs::srv::GenerateTwists_Response>()
{
  return "dwb_msgs::srv::GenerateTwists_Response";
}

template<>
constexpr const char * name<dwb_msgs::srv::GenerateTwists_Response>()
{
  return "dwb_msgs/srv/GenerateTwists_Response";
}
...
template<>
struct MessageTraits<dwb_msgs::srv::GenerateTwists_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "twists",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dwb_msgs::srv::GenerateTwists_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<dwb_msgs::srv::GenerateTwists_Event>()
{
  return "dwb_msgs::srv::GenerateTwists_Event";
}

template<>
constexpr const char * name<dwb_msgs::srv::GenerateTwists_Event>()
{
  return "dwb_msgs/srv/GenerateTwists_Event";
}
...
template<>
struct MessageTraits<dwb_msgs::srv::GenerateTwists_Event>
{
...
template<>
constexpr const char * data_type<dwb_msgs::srv::GenerateTwists>()
{
  return "dwb_msgs::srv::GenerateTwists";
}

template<>
constexpr const char * name<dwb_msgs::srv::GenerateTwists>()
{
  return "dwb_msgs/srv/GenerateTwists";
}
