...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dwb_msgs::srv::GenerateTrajectory_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).start_pose,
    std::forward<T>(msg).start_vel,
    std::forward<T>(msg).cmd_vel);
}
...
template<>
constexpr const char * data_type<dwb_msgs::srv::GenerateTrajectory_Request>()
{
  return "dwb_msgs::srv::GenerateTrajectory_Request";
}

template<>
constexpr const char * name<dwb_msgs::srv::GenerateTrajectory_Request>()
{
  return "dwb_msgs/srv/GenerateTrajectory_Request";
}
...
template<>
struct MessageTraits<dwb_msgs::srv::GenerateTrajectory_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dwb_msgs::srv::GenerateTrajectory_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).traj);
}
...
template<>
constexpr const char * data_type<dwb_msgs::srv::GenerateTrajectory_Response>()
{
  return "dwb_msgs::srv::GenerateTrajectory_Response";
}

template<>
constexpr const char * name<dwb_msgs::srv::GenerateTrajectory_Response>()
{
  return "dwb_msgs/srv/GenerateTrajectory_Response";
}
...
template<>
struct MessageTraits<dwb_msgs::srv::GenerateTrajectory_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dwb_msgs::srv::GenerateTrajectory_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<dwb_msgs::srv::GenerateTrajectory_Event>()
{
  return "dwb_msgs::srv::GenerateTrajectory_Event";
}

template<>
constexpr const char * name<dwb_msgs::srv::GenerateTrajectory_Event>()
{
  return "dwb_msgs/srv/GenerateTrajectory_Event";
}
...
template<>
struct MessageTraits<dwb_msgs::srv::GenerateTrajectory_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<dwb_msgs::srv::GenerateTrajectory>()
{
  return "dwb_msgs::srv::GenerateTrajectory";
}

template<>
constexpr const char * name<dwb_msgs::srv::GenerateTrajectory>()
{
  return "dwb_msgs/srv/GenerateTrajectory";
}
