...
dwb_msgs__srv__GenerateTrajectory_Request__Sequence__init(dwb_msgs__srv__GenerateTrajectory_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(dwb_msgs__srv__GenerateTrajectory_Request)) {
      return false;
    }
  ...
  dwb_msgs__srv__GenerateTrajectory_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(dwb_msgs__srv__GenerateTrajectory_Request)) {
      return false;
    }
...
dwb_msgs__srv__GenerateTrajectory_Response__Sequence__init(dwb_msgs__srv__GenerateTrajectory_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(dwb_msgs__srv__GenerateTrajectory_Response)) {
      return false;
    }
  ...
  dwb_msgs__srv__GenerateTrajectory_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(dwb_msgs__srv__GenerateTrajectory_Response)) {
      return false;
    }
    const size_t allocation_size =
...
dwb_msgs__srv__GenerateTrajectory_Event__Sequence__init(dwb_msgs__srv__GenerateTrajectory_Event__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(dwb_msgs__srv__GenerateTrajectory_Event)) {
      return false;
    }
  ...
  dwb_msgs__srv__GenerateTrajectory_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(dwb_msgs__srv__GenerateTrajectory_Event)) {
      return false;
    }
    const size_t allocation_size =
