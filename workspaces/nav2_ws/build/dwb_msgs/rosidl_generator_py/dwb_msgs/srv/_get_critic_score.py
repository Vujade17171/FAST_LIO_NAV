...
class Metaclass_GetCriticScore_Request(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class GetCriticScore_RequestConstants(typing.TypedDict):
        pass

    __constants: GetCriticScore_RequestConstants = {
    }
...
class GetCriticScore_Request(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_GetCriticScore_Request):
    ...
    def __init__(self, *,
                 ...
                 critic_name: typing.Optional[str] = None,  # noqa: E501
        ...
        self.critic_name = critic_name if critic_name is not None else str()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, GetCriticScore_Request):
            return False
    ...
    @critic_name.setter
    def critic_name(self, value: str) -> None:
...
class Metaclass_GetCriticScore_Response(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class GetCriticScore_ResponseConstants(typing.TypedDict):
        pass

    __constants: GetCriticScore_ResponseConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if CriticScore._TYPE_SUPPORT is None:
                CriticScore.__import_type_support__()
...
class GetCriticScore_Response(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_GetCriticScore_Response):
    ...
    def __init__(self, *,
                 score: typing.Optional[dwb_msgs.msg.CriticScore] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
            self._check_fields = ros_python_check_fields == '1'
        from dwb_msgs.msg import CriticScore
        self.score = score if score is not None else CriticScore()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, GetCriticScore_Response):
            return False
    ...
    @builtins.property
    def score(self) -> dwb_msgs.msg.CriticScore:
        """Message field 'score'."""
        return self._score

    @score.setter
    def score(self, value: dwb_msgs.msg.CriticScore) -> None:
        from dwb_msgs.msg import CriticScore
...
class Metaclass_GetCriticScore_Event(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class GetCriticScore_EventConstants(typing.TypedDict):
        pass

    __constants: GetCriticScore_EventConstants = {
    }
...
class GetCriticScore_Event(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_GetCriticScore_Event):
    ...
    def __init__(self, *,
                 ...
                 request: typing.Optional[collections.abc.Sequence[dwb_msgs.srv.GetCriticScore_Request]] = None,  # noqa: E501
                 response: typing.Optional[collections.abc.Sequence[dwb_msgs.srv.GetCriticScore_Response]] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, GetCriticScore_Event):
            return False
    ...
    @builtins.property
    def request(self) -> typing.Annotated[typing.Any, list[dwb_msgs.srv.GetCriticScore_Request]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'request'."""
        return self._request

    @request.setter
    def request(self, value: collections.abc.Sequence[dwb_msgs.srv.GetCriticScore_Request]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'request' field must be sequence with length <= 1 and each value of type 'GetCriticScore_Request'"
    ...
    @builtins.property
    def response(self) -> typing.Annotated[typing.Any, list[dwb_msgs.srv.GetCriticScore_Response]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'response'."""
        return self._response

    @response.setter
    def response(self, value: collections.abc.Sequence[dwb_msgs.srv.GetCriticScore_Response]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'response' field must be sequence with length <= 1 and each value of type 'GetCriticScore_Response'"
...
class Metaclass_GetCriticScore(rosidl_pycommon.interface_base_classes.ServiceTypeSupportMeta):
...
class GetCriticScore(rosidl_pycommon.interface_base_classes.BaseService[
    GetCriticScore_Request,
    GetCriticScore_Response
], metaclass=Metaclass_GetCriticScore):
    Request: TypeAlias = GetCriticScore_Request
    Response: TypeAlias = GetCriticScore_Response
    Event: TypeAlias = GetCriticScore_Event
