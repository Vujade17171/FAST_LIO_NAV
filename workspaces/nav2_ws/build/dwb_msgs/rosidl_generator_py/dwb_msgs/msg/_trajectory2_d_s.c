...
bool dwb_msgs__msg__trajectory2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dwb_msgs.msg._trajectory2_d", (char *)PyUnicode_1BYTE_DATA(module_attr), 27) == 0);
    assert(strncmp("Trajectory2D", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);
