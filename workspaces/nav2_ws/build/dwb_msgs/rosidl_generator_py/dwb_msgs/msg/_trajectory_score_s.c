...
bool dwb_msgs__msg__trajectory_score__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dwb_msgs.msg._trajectory_score", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("TrajectoryScore", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
