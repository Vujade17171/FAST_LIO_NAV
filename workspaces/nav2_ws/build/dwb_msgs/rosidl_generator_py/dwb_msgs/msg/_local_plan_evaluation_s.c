...
bool dwb_msgs__msg__local_plan_evaluation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dwb_msgs.msg._local_plan_evaluation", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("LocalPlanEvaluation", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
