...
struct Pose6D_
{
  ...
  explicit Pose6D_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill(this->gyr.begin(), this->gyr.end(), 0.0);
      std::fill(this->vel.begin(), this->vel.end(), 0.0);
      std::fill(this->pos.begin(), this->pos.end(), 0.0);
      std::fill(this->rot.begin(), this->rot.end(), 0.0);
    }
  }
