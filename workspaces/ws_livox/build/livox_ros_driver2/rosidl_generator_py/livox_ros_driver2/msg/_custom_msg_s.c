...
bool livox_ros_driver2__msg__custom_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("livox_ros_driver2.msg._custom_msg", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("CustomMsg", (char *)PyUnicode_1BYTE_DATA(name_attr), 9) == 0);
